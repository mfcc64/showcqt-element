...
import "https://cdn.jsdelivr.net/npm/showcqt-element@1.3.0/showcqt-element.mjs";
```
- A simple example:
```html
<!DOCTYPE html>
<html>
    <head>
        ...
        <script type="module" src="https://cdn.jsdelivr.net/npm/showcqt-element@1.3.0/showcqt-element.mjs"></script>
        <script type="module">
